...
const AboutSection = () => {
  return (
    <>
      <div className="flex flex-col md:items-center justify-start lg:justify-center relative -pt-2 lg:-mt-[02vh] w-full lg:px-16 gap-2 lg:gap-8">
        <h1 className="text-4xl font-bold text-[#FDE36E] font-oddval text-center -mt-[10vh] lg:-mt-[15vh]">
          ABOUT
        </h1>
