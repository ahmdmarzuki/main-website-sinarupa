    ...
    <>
      <div className="flex flex-col md:items-center md:justify-center relative md:mt-10 w-full md:px-16 gap-8">
        ...
        <div className="relative">
          <img
            ...
            className="absolute w-full h-full max-w-[2800px]"
          />
          <div className="relative text-base md:text-md mx-auto text-[#5740d2] font-host md:text-center whitespace-pre-line flex-col px-8 py-16">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-20 mt-25">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-4xl font-bold text-[#5740d2] font-oddval">
              DATE
            </h1>
            <p className="text-xl font-bold text-[#5740d2] font-host">
              28 – 29 Juni 2025
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-lg font-bold text-[#5740d2] font-host">
              GSG ITB Jatinangor
            </p>
          </div>
