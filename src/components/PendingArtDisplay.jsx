          ...
          {filteredArtList.map((art) => (
            ...
            >
              <div className="flex gap-8 w-full">
                {/* Artwork Preview: Support image and video using fileType, with hover overlay */}
                {art.artUrl && (
                ...
                <div className="flex-1 max-w-[66%] ">
                  ...
                  <p className="text-gray-700 text-sm sm:text-base mb-2 sm:mb-4 line-clamp-2 max-w-[80%]">
                    {art.artDesc}
                  </p>
                </div>
              </div>
