...
const ModalDisclaimer = ({ onAgree, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
      ...
      {/* Disclaimer Modal */}
      {showDisclaimer && (
        <div className="bg-white rounded-xl shadow-xl max-w-md w-full my-16 p-6 overflow-y-auto z-50">
          <div className="overflow-y-auto">
            ...
            <p className="">
              ...
              <br />
              Sebelum kita lanjut, ada beberapa hal penting yang perlu kamu
              tahu, ya!
            </p>
            <div className="">
              <ol>
                ...
                <li>
                  Aku adalah chatbot untuk bantu jawab pertanyaan kamu soal
                  acara ini. Tapi kadang-kadang jawabanku bisa aja kurang tepat.
                  Kalau ragu, tanya ke panitia ya!
                </li>
                <li>Jangan terlalu serius sama semua jawabanku.</li>
                <li>
                  Aku belajar dari banyak data, tapi aku bukan sumber kebenaran
                  mutlak. Info penting atau sensitif? Konfirmasi ke panitia
                  juga!
                </li>
                <li>Privasi kamu aman kok!</li>
                <li>
                  Aku nggak simpan data pribadi kamu. Obrolan ini cuma buat
                  bantu kamu selama acara aja.
                </li>
