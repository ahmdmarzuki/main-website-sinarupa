...
<div className="relative z-10 flex flex-col h-full w-full px-6 pt-[22vh] md:hidden">
  ...
  <div className="flex justify-center">
    <img src="/images/Sinarupa.png" alt="Sinarupa" className="w-[400px]" />
  </div>

  {/* Tombol DAFTAR */}
  <div className="flex justify-center mt-6">
    <Link to="/landing" className="relative w-[190px] hover:scale-105 transition">
  ...
  <div className="absolute bottom-6 right-4 flex flex-col items-end gap-3">
    {["MERCH", "CHATBOT", "GAME"].map((label, i) => (
      <Link to="#" key={i} className="relative w-[160px] hover:scale-105 transition">
        <img src="/images/button1.png" alt={`Button ${label}`} className="w-full" />
        <div className="absolute inset-0 flex items-center justify-center">
